...
<html lang="en">
    <head>
        <title>Transaction History- PNWX</title>
        <link rel="icon" href="Pictures/icon.png">
        <link rel="shortcut icon" href="Pictures/icon.png">
        <link rel="stylesheet" href="CSS/user_trans_list.css">
    </head>
    ...
    <body>
        ...
        <header>
            ...
            <span class = "menu">
                ...
                <a id="active" href="user_trans_list.php"> Transaction History </a>
            ...
            <?php
                ...
                if(mysqli_num_rows($isFound) > 0)
                {
                    while($row = mysqli_fetch_assoc($isFound))
                    {
                        ...
                        echo '<a href="receipt.php?receipt='.$row['id'].'" target="_blank">';
