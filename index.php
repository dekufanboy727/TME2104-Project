...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="http://www.pnwx.com/favicon.ico">
        <link rel="shortcut icon" href="http://www.pnwx.com/favicon.ico">
    ...
    <body>
        ...
        <main>
            <section class="HomepageBanner">
              <div class="row">
                <img src="Pictures/pnwxHomePage.png" alt="Homepage Banner" class="HomepageBanner">
              </div>
            </section>
            <br>
